...
llm = ChatGroq(
    ...
    model="mistral-saba-24b",  # Specify the LLaMA model
    ...
    try:
        ...
        with open(file_name, 'r', encoding=encoding) as f:
            ...
            for index, (state, cursor_position, resulted_prefix, struct_candi, text_candi) in enumerate(resultlist, start=1):
                ...
                parent_folder = "./mistral/SB with Ideal Guide"
                if prog_lan == "C11":
...
infile = './SB_Data/19_Fractal.data' # data file       
infile1 = './SB_Sample/19_Fractal.sb'   # source code file      \19_Fractal_result.txt
prog_lan= "Small Basic"
encoding = 'utf-16'
